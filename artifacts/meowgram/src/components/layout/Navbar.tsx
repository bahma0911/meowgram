      ...
      <div className="container mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          {isAuthenticated && user ? (
            <>
              <Link href="/upload">
                <Button variant="default" size="sm" className="hidden lg:flex rounded-full gap-2 shadow-md shadow-primary/20">
                  <PlusSquare className="w-4 h-4" /> Create Post
                </Button>
              </Link>
              <div className="h-8 w-[1px] bg-border mx-1 hidden lg:block"></div>
